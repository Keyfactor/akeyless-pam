...
<a href="https://github.com/Keyfactor/Akeyless PAM Provider/releases"><img src="https://img.shields.io/github/v/release/Keyfactor/Akeyless PAM Provider?style=flat-square" alt="Release" /></a>
<img src="https://img.shields.io/github/issues/Keyfactor/Akeyless PAM Provider?style=flat-square" alt="Issues" />
<img src="https://img.shields.io/github/downloads/Keyfactor/Akeyless PAM Provider/total?style=flat-square&label=downloads&color=28B905" alt="GitHub Downloads (all assets, all releases)" />
</p>
...
```shell
# Akeyless
kfutil pam types-create -r Akeyless PAM Provider -n Akeyless
```
