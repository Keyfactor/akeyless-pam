    ...
    "Parameters": [
        {
            ...
            "Description": "The URL to the Secret Server instance. Example: https://example.cloud.com/",
            "DataType": 1,
            "InstanceLevel": false
        },
        {
...
| --- | --- | --- |
| Url | Secret Server URL | The URL to the Secret Server instance. Example: https://example.cloud.com/ |
